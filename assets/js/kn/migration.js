/* kn/migration.js — ported from assets/js/migration.js for the Hugo build.
   Carried over ~unchanged (self-contained [data-action] runtime). Only chrome
   selectors were repointed for the theme: '.topbar' -> '.header' (scroll math),
   #sidebar -> #knToolSidebar (tool's own section nav). copyToClipboard comes from
   kn/chrome.js, loaded first. Version consts stay inline (Phase 4 routes them via
   window.NGINX_K8S_VERSIONS). */
